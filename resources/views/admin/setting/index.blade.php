            ...
            <div class="panel-body">
                <form action="{{ route('admin.setting.update') }}" method="POST">
                    ...
                    <div class="form-group{{ $errors->has('company') ? ' has-error' : '' }}">
                        ...
                        <input type="text" class="form-control" id="company" name="company" value="{{ old('company') ?: $setting->company }}">
                    ...
                    <div class="form-group{{ $errors->has('welcome_title') ? ' has-error' : '' }}">
                        ...
                        <input type="text" class="form-control" id="welcome_title" name="welcome_title" value="{{ old('welcome_title') ?: $setting->welcome_title }}">
                    ...
                    <div class="form-group{{ $errors->has('welcome_content') ? ' has-error' : '' }}">
                        ...
                        <textarea class="form-control" id="welcome_content" name="welcome_content" rows="3">{{ old('welcome_content') ?: $setting->welcome_content }}</textarea>
                    ...
                    <div class="form-group{{ $errors->has('service_title') ? ' has-error' : '' }}">
                        ...
                        <input type="text" class="form-control" id="service_title" name="service_title" value="{{ old('service_title') ?: $setting->service_title }}">
                    ...
                    <div class="form-group{{ $errors->has('service_content') ? ' has-error' : '' }}">
                        ...
                        <textarea class="form-control" id="service_content" name="service_content" rows="3">{{ old('service_content') ?: $setting->service_content }}</textarea>
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="weibo" name="weibo" value="{{ old('weibo') ?: $setting->weibo }}">
                    </div>
                    <!-- Fackbook field -->
                    <div class="form-group">
